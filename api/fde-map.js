...
<tr><td align="center" style="padding:32px 16px;">
  <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;background:#ffffff;border:1px solid #e8e8ec;border-radius:16px;overflow:hidden;">
    ...
    <tr><td style="padding:22px 32px 0;">
      <div style="font-family:${FONT};font-size:11px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:${ACCENT};">Forward Deployment Map</div>
    ...
    <tr><td style="padding:28px 32px 32px;">
      ...
      <div style="font-family:${FONT};font-size:12px;color:#9a9aa2;line-height:1.7;">
        Generated by the Forward Deployment Map.<br>
...
export default async function handler(req, res) {
  ...
  const leadBody = [
    'New Forward Deployment Map submission.',
    '',
  ...
  const ownerHtml = ownerLeadEmail({
    source: 'Forward Deployment Map', name, replyEmail: email,
    rows: [
  ...
  try {
    ...
    console.error('Forward deployment map send error:', err);
    return res.status(500).json({
      success: false,
      message: 'Something went wrong — please try again or contact hello@leongovier.com.',
    });
